...
static const mbedtls_ssl_ciphersuite_t ciphersuite_definitions[] =
{
    ...
    { MBEDTLS_GM_SM2_WITH_SM4_CBC_SM3, "GM-SM2-WITH-SM4-CBC-SM3",
      MBEDTLS_CIPHER_SM4_CBC, MBEDTLS_MD_SM3, MBEDTLS_KEY_EXCHANGE_SM2,
      MBEDTLS_GM_MAJOR_VERSION_1, MBEDTLS_GM_MINOR_VERSION_1,
      MBEDTLS_GM_MAJOR_VERSION_1, MBEDTLS_GM_MINOR_VERSION_1,
      0 },
#endif /* MBEDTLS_SM3_C */
#endif /* MBEDTLS_SM4_C */
...
#if defined(MBEDTLS_SM4_C)
#if defined(MBEDTLS_SM3_C)
    { MBEDTLS_GM_RSA_WITH_SM4_CBC_SM3, "GM-RSA-WITH-SM4-CBC-SM3",
      MBEDTLS_CIPHER_SM4_CBC, MBEDTLS_MD_SM3, MBEDTLS_KEY_EXCHANGE_RSA,
      MBEDTLS_GM_MAJOR_VERSION_1, MBEDTLS_GM_MINOR_VERSION_1,
      MBEDTLS_GM_MAJOR_VERSION_1, MBEDTLS_GM_MINOR_VERSION_1,
      0 },
#endif /* MBEDTLS_SM3_C */
#if defined(MBEDTLS_SHA1_C)
    { MBEDTLS_GM_RSA_WITH_SM4_CBC_SHA1, "GM-RSA-WITH-SM4-CBC-SHA",
      MBEDTLS_CIPHER_SM4_CBC, MBEDTLS_MD_SHA1, MBEDTLS_KEY_EXCHANGE_RSA,
      MBEDTLS_GM_MAJOR_VERSION_1, MBEDTLS_GM_MINOR_VERSION_1,
      MBEDTLS_GM_MAJOR_VERSION_1, MBEDTLS_GM_MINOR_VERSION_1,
      0 },
#endif /* MBEDTLS_SHA1_C */
