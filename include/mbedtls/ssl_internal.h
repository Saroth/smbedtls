...
#define MBEDTLS_SSL_MIN_MINOR_VERSION           MBEDTLS_GM_MINOR_VERSION_1
...
#if defined(MBEDTLS_GM_PROTO_TLS1_1)
#define MBEDTLS_SSL_MAX_MAJOR_VERSION           MBEDTLS_GM_MAJOR_VERSION_1
#else
#define MBEDTLS_SSL_MAX_MAJOR_VERSION           MBEDTLS_SSL_MAJOR_VERSION_3
#endif /* MBEDTLS_GM_PROTO_TLS1_1 */

#if defined(MBEDTLS_GM_PROTO_TLS1_1)
#define MBEDTLS_SSL_MAX_MINOR_VERSION           MBEDTLS_GM_MINOR_VERSION_1
#else
#if defined(MBEDTLS_SSL_PROTO_TLS1_2)
